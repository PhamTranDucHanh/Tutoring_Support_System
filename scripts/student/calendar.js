...
document.addEventListener('DOMContentLoaded', function () {
	...
	if (!calendarEl) {
		...
		calendarEl.id = 'student-calendar';
	...
	// Helper: lấy danh sách session của sinh viên
	async function loadStudentSessions() {
		...
		if (!student || !Array.isArray(student.registeredCourses)) return [];
	...
	(async function () {
		const allSessions = await loadStudentSessions();
		sessionsByDate = {};
